...
echo "$($PSQL "SELECT DISTINCT(name) FROM teams FULL JOIN games ON (teams.team_id=games.opponent_id OR teams.team_id=games.winner_id) WHERE round='Eighth-Final' and YEAR=2014 ORDER BY name")"
